...
While the original paper used Stata [@citeStata] for data processing and analysis in its replication package, we use R [@citeR] for all data wrangling and analysis.
